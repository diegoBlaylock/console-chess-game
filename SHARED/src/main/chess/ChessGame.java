...
public interface ChessGame {
    ...
    enum TeamColor {
        ...
        public TeamColor next() {
            return TeamColor.getNext(this);
        }

        public static TeamColor getNext(TeamColor color) {
            return TeamColor.values()[(color.ordinal() + 1) % TeamColor.values().length];
        }
    }
    ...
    boolean shouldPromotionOccur(ChessMove move);
